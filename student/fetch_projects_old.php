...
// This query now filters out projects the student has applied to.
$stmt = $conn->prepare("
    SELECT p.*, 
...
<?php if ($projects->num_rows === 0): ?>
    <div style="text-align: center; padding: 40px; color: #64748b;">
        ...
        <p style="font-size: 1.1rem; margin-bottom: 8px;">No New Projects Available</p>
        <p style="font-size: 0.9rem;">You have applied to all available projects, or there are no new listings. Check back later!</p>
    </div>
<?php else: ?>
